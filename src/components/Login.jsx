      ...
      <div className="w-full max-w-md lg:max-w-lg xl:max-w-xl">
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center mb-4">
            <Building2 className="h-8 w-8 md:h-10 md:w-10 lg:h-12 lg:w-12 text-blue-600 mr-2" />
            <Shield className="h-8 w-8 md:h-10 md:w-10 lg:h-12 lg:w-12 text-green-600" />
          </div>
          <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900">CCL Mining</h1>
          <p className="text-gray-600 mt-2 text-sm md:text-base lg:text-lg">Employee Record & Compliance Management</p>
        </div>

        <Card className="backdrop-blur-lg bg-white/90 shadow-2xl border-0 rounded-2xl">
          <CardHeader className="text-center pb-4">
            <CardTitle className="text-lg md:text-xl lg:text-2xl font-bold text-gray-800">Sign In</CardTitle>
          ...
          <CardContent className="px-4 md:px-6 lg:px-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <fieldset className="border border-gray-200 rounded-xl p-4 md:p-5 lg:p-6 space-y-4">
                <legend className="text-xs md:text-sm lg:text-base font-semibold text-gray-700 px-2">Login Credentials</legend>
            ...
            <div className="mt-6">
              ...
              <Button
                type="button"
                variant="outline"
                className="w-full mt-4 border-2 border-gray-200 hover:border-gray-300 bg-white/80 backdrop-blur-sm hover:bg-white rounded-xl py-2 md:py-3 font-medium transform hover:scale-105 transition-all duration-300 group"
