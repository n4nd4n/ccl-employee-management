      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-8 animate-fadeInUp">
          <div className="flex items-center justify-center mb-4 transform hover:scale-110 transition-transform duration-300">
            <Building2 className="h-12 w-12 text-blue-600 mr-2 animate-bounce" style={{animationDelay: '0.5s'}} />
            <Shield className="h-12 w-12 text-green-600 animate-bounce" style={{animationDelay: '1s'}} />
          </div>
          ...
          <p className="text-gray-600 mt-2 text-lg">Employee Record & Compliance Management</p>
        </div>
